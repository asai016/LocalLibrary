...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        import uuid
        test_uid = uuid.uuid4()  # маловероятный UID чтобы соответствовать нашему bookinstance!
        login = self.client.login(username='testuser2', password='12345')
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        # ИСПРАВЛЕННАЯ СТРОКА - получаем форму из контекста
        form = resp.context['form']
        self.assertFormError(form, 'due_back', 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        form = resp.context['form']
        self.assertFormError(form, 'due_back', 'Invalid date - renewal more than 4 weeks ahead')